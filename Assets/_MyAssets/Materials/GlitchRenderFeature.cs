...
public class GlitchRenderFeature : ScriptableRendererFeature
{
    ...
    class GlitchRenderPass : ScriptableRenderPass
    {
        ...
        private readonly string profilerTag = "GlitchRender Pass";
    ...
    public override void Create()
    {
        if(glitchSetting != null)
        {
            ...
            m_ScriptablePass.renderPassEvent = glitchSetting.renderPassEvent;
            m_ScriptablePass.postEffectMaterial = glitchSetting.material;
        }
    }
    ...
    {
        if(m_ScriptablePass != null && m_ScriptablePass.postEffectMaterial != null)
        {
